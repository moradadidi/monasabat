...
<div class="home">
    <nav class="bg-orange-500 p-4 fixed w-full z-40">
        <div class="container mx-auto flex justify-between p-1 items-center">
            ...
            <form action="" method="get" id="search-form" class="flex items-center border border-gray-300 rounded-md overflow-hidden bg-white">
                ...
                <button type="submit"><i class="fa-solid fa-magnifying-glass text-3xl text-white"></i></button>
            </form>
        </div>
    </nav>
                ...
                <?php foreach ($products as $deal) : ?>
                    ...
                    <img src="../admin/<?= htmlspecialchars($deal['photo']) ?>" class="cursor-pointer h-full product-image" alt="<?= htmlspecialchars($deal['nom_product']) ?>" data-product-id="<?= $deal['id_product'] ?>">
                        ...
                        <form action="" method="post" class="absolute top-0 left-0 right-0 flex justify-between p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            ...
                            <button name="add" class=" text-orange-500 py-2 px-4 rounded-lg "><i class="fa-solid fa-cart-plus text-4xl"></i></button>
                        </form>
                    </div>
                <?php endforeach; ?>
            </div>
